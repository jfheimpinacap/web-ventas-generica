  ...
  return (
    <Layout onSearch={(term) => navigate(term ? `/catalogo?search=${encodeURIComponent(term)}` : '/')}>
      ...
      <section className="home-introduction">
        ...
        <div className="home-introduction__actions"><Link className="btn btn--ghost" to="/catalogo">Ver catálogo</Link><Link className="btn btn--accent" to="/cotizar" onClick={() => trackQuoteClick({ location: 'home_intro' })}>Solicitar cotización</Link></div>
