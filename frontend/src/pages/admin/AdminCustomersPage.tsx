...
export function AdminCustomersPage() {
  ...
  return <AdminLayout>
    ...
    <section className="admin-customer-filters admin-block" aria-label="Filtros de clientes">
      ...
      <label>Estado<select className="admin-search" value={status} onChange={event => updateParams({ status: event.target.value as CustomerStatus, page: 1 })}><option value="all">Todos</option><option value="active">Activos</option><option value="inactive">Inactivos</option></select></label>
    </section>
