...
export function CustomerSearch({ disabled, selectedId, onSelect, onUnlink, navigationAction }: { disabled: boolean; selectedId: number | null; onSelect: (value: CustomerProfile) => void; onUnlink: () => void; navigationAction?: ReactNode }) {
