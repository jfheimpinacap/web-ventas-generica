  ...
  return (
    <form className="admin-product-form" onSubmit={handleSubmit}>
      ...
      <section className="admin-form-panel admin-form-panel--stack">
        ...
        <label>
          Contacto
          <input value={values.contact_name} onChange={(e) => setValues((p) => ({ ...p, contact_name: e.target.value }))} />
        </label>
        ...
        <label>
          Email
          <input type="email" value={values.email} onChange={(e) => setValues((p) => ({ ...p, email: e.target.value }))} />
        </label>

        <label className="admin-form-panel__full">
          Notas
          <textarea rows={4} value={values.notes} onChange={(e) => setValues((p) => ({ ...p, notes: e.target.value }))} />
        </label>
