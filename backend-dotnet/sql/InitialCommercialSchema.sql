...
CREATE TABLE [HomeSectionItems] (
    ...
    CONSTRAINT [FK_HomeSectionItems_Products_ProductId] FOREIGN KEY ([ProductId]) REFERENCES [Products] ([Id]) ON DELETE CASCADE
);
GO
...
CREATE TABLE [QuoteRequests] (
    ...
    CONSTRAINT [FK_QuoteRequests_Products_ProductId] FOREIGN KEY ([ProductId]) REFERENCES [Products] ([Id]) ON DELETE SET NULL
);
GO
