...
public sealed record ProductImageReadDto(
    ...
    int Product,
    string Image,
    [property: System.Text.Json.Serialization.JsonPropertyName("file_url")] string FileUrl,
    string AltText,
    bool IsMain,
    int Order,
    DateTimeOffset CreatedAt)
{
    public static ProductImageReadDto FromImage(ProductImage image) => new(
        ...
        image.ProductId,
        image.Image,
        $"/api/product-images/{image.Id}/file",
        image.AltText,
        image.IsMain,
        image.Order,
        image.CreatedAt);
...
public sealed record ProductListReadDto(
    ...
    string Description,
    string? Sku,
    decimal? WorkingHeightM,
    string? TerrainType,
    int? Year,
    int? HoursMeter,
    decimal? MaximumLoadCapacityKg,
    decimal? MachineWeightKg,
    string? PowerSource,
    bool IncludesTechnicalReview,
    bool IncludesCommercialTechnicalAdvice,
    bool IncludesCoordinatedDelivery,
    decimal? Price,
    ...
    DateTimeOffset UpdatedAt)
{
    public static ProductListReadDto FromProduct(Product product) => new(
        ...
        product.Description,
        product.Sku,
        product.WorkingHeightM,
        product.TerrainType,
        product.Year,
        product.HoursMeter,
        product.MaximumLoadCapacityKg,
        product.MachineWeightKg,
        product.PowerSource,
        product.IncludesTechnicalReview,
        product.IncludesCommercialTechnicalAdvice,
        product.IncludesCoordinatedDelivery,
        product.Price,
...
public sealed record ProductDetailReadDto(
    ...
    [property: System.Text.Json.Serialization.JsonPropertyName("technical_sheet")] TechnicalSheetResponse? TechnicalSheet,
    string ProductType,
    string Condition,
    string ShortDescription,
    string Description,
    ...
    DateTimeOffset UpdatedAt)
{
    public static ProductDetailReadDto FromProduct(Product product)
    {
        ...
        return new ProductDetailReadDto(
            ...
            product.TechnicalSheet is null ? null : TechnicalSheetDtoMapper.ToResponse(product.TechnicalSheet),
            product.ProductType,
            product.Condition,
            product.ShortDescription,
            product.Description,
            product.Model,
            product.ProductType == ProductTypes.SparePart ? product.Sku : null,
            product.WorkingHeightM,
            product.TerrainType,
            product.Year,
            product.HoursMeter,
            product.MaximumLoadCapacityKg,
            product.ProductType == ProductTypes.Machinery ? product.MachineWeightKg : null,
            product.PowerSource,
            product.IncludesTechnicalReview,
            product.IncludesCommercialTechnicalAdvice,
            product.IncludesCoordinatedDelivery,
