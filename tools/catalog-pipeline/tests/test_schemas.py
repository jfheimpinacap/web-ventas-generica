...
class SchemaTests(unittest.TestCase):
 def test_every_schema_has_valid_synthetic_fixture(self):
  ...
  self.assertEqual(81,len(schemas))
  ...
  local_names={'local-apply-authorization','local-operation-receipt','local-apply-checkpoint','local-apply-manifest','local-verification-report','local-readiness-report','local-binary-observation-plan'}
