...
def canonical_package(directory,blocked=0,excluded=0):
 ...
 identity=canonical_identity("SYN","MODEL-1").value; observation={"observation_id":"normalized-observation-1","canonical_identity":identity,"source_field_key":"working_height","source_label":"Working height","raw_value":"3.000","raw_unit":"m","normalized_value":"3.000","normalized_unit":"m","source":"fixture","source_url":None,"source_document":"fixture.html","source_page":"1","source_section":"specifications","extraction_rule":"table.v1","evidence_references":["e-1"],"relation_references":[],"locale":"en","qualifiers":[],"rule_id":"height.v1","rule_version":"1","policy_fingerprint":"a"*64,"resolution_status":"exact","conflict_group":None,"review_references":[]}; product={"schema_version":"1.0.0","document_kind":"normalized_for_audit_not_api_payload","canonical_identity":identity,"brand_code":"SYN","canonical_model":"MODEL-1","category_mapping":{"name":"Elevadores","slug":"elevadores","product_type":"machinery"},"structured_fields":{"WorkingHeightM":{"value":"3.000","unit":"m","status":"exact","observation_reference":"normalized-observation-1"}},"product_specs":[],"observations":[observation],"media":[asset("products/p/primary.png",image1,"primary","image/png"),asset("products/p/secondary.png",image2,"secondary","image/png",1)],"technical_sheet":asset("products/p/sheet.pdf",sheet,"technical_sheet","application/pdf"),"additional_documents":[asset("products/p/extra.pdf",extra,"additional_document","application/pdf")],"commercial":{"price":None,"price_visible":False,"is_featured":False,"is_published":False}}
 ...
 package_plan={"schema_version":"1.0.0","package_schema_version":"1.0.0","producer":"catalog-package","package_policy":policy,"audit_manifest_fingerprint":"a"*64,"included_products":[] if blocked else [identity],"excluded_product_count":excluded,"blocked_product_count":blocked,"decision_fingerprint":"d"*64,"entries":entries,"content_fingerprint":fingerprint({"entries":descriptors,"policy_fingerprint":policy["fingerprint"],"audit_fingerprint":"a"*64,"decision_fingerprint":"d"*64}),"entry_count":len(entries)+1,"total_uncompressed_size":sum(len(x) for x in files.values()),"blocking":bool(blocked),"fixture_only":True,"source_root":".","upstream_fingerprints":{}}
